    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 23, 1, 52, 12, 22, DateTimeKind.Utc).AddTicks(1040), null, "Administrador del sistema", true, "Admin", null, null },
                    { 2, new DateTime(2024, 12, 23, 1, 52, 12, 22, DateTimeKind.Utc).AddTicks(1040), null, "Usuario regular del sistema", true, "User", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_UserId_InvalidatedAt_UsedAt_ExpiresAt",
                table: "RefreshTokens",
                columns: new[] { "UserId", "InvalidatedAt", "UsedAt", "ExpiresAt" });
